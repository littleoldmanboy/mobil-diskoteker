...
export default async function Header() {
    ...
    return (
        <Bounded as="header" className="text-white bg-darkGray flex justify-between fixed w-full z-50">
            <Logo />

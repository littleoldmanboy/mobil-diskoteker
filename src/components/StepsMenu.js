                      ...
                      return (
                        <div key={i} className="relative w-fit drop-shadow-[-3px_0.5px_6px_rgba(0,0,0,0.1)]">
                          ...
                          <TooltipProvider delayDuration={250}>
                            <Tooltip>
                              <TooltipTrigger className="absolute top-[-6px] right-0 bg-darkGray h-5 w-5 text-[13px] font-normal text-[#a7a7a7] rounded-full transition-colors duration-200 ease-in-out border border-[#6a6a6a] hover:bg-[#303030] hover:text-white">
                                i
                              </TooltipTrigger>
                              <TooltipContent className="text-center bg-[#333333] py-3 px-4 mt-2 rounded-xl text-[#e7e7e7] text-[13px] font-normal tracking-wider">
                                {
